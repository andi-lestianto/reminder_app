...
class $AssetsIconsGen {
  ...
  SvgGenImage get alarmClock =>
      const SvgGenImage('assets/icons/alarm-clock.svg');

  /// File path: assets/icons/arrow-small-right.svg
  SvgGenImage get arrowSmallRight =>
      const SvgGenImage('assets/icons/arrow-small-right.svg');

  /// File path: assets/icons/bell-notification-social-media.svg
  SvgGenImage get bellNotificationSocialMedia =>
      const SvgGenImage('assets/icons/bell-notification-social-media.svg');

  /// File path: assets/icons/calendar-clock.svg
  SvgGenImage get calendarClock =>
      const SvgGenImage('assets/icons/calendar-clock.svg');
  ...
  /// File path: assets/icons/file-edit.svg
  SvgGenImage get fileEdit => const SvgGenImage('assets/icons/file-edit.svg');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/dummy_recipe.jpeg
  AssetGenImage get dummyRecipe =>
      const AssetGenImage('assets/images/dummy_recipe.jpeg');

  /// List of all assets
  List<AssetGenImage> get values => [dummyRecipe];
}
